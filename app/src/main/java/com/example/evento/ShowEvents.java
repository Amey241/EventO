...
//                    Toast.makeText(ShowEvents.this, "" + jsonArray.length(), Toast.LENGTH_LONG).show();
                    if (jsonArray.length() > 0) {
                        ...
                        Toast.makeText(ShowEvents.this, "Something went wrong", Toast.LENGTH_LONG).show();
                    }
                    adapter = new CustomAdapterName(ShowEvents.this, rowItems);
